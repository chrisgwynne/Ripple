...
object MapGenerator {
    ...
    private fun placeCivicBuildings(lots: MutableList<BuildingLot>) {
        val specs = listOf(
            ...
            CivicSpec("Northern Warehouse",       BuildingType.WORKSHOP,
            ...
            // ---- Business Park (new) ----
            CivicSpec("Ashcombe Technology Park",  BuildingType.TOWN_HALL,
            ...
            CivicSpec("Business Park Café",        BuildingType.CAFE,
                ...
                districtType=DistrictType.BUSINESS_PARK),
            CivicSpec("Ashcombe Offices",          BuildingType.WORKSHOP,
            ...
            CivicSpec("Business Park Clinic",      BuildingType.CLINIC,
                x=216, y=23, w=3, h=3, doorX=217, doorY=22, noise=8.0, capacity=8, value=80_000.0,
                districtType=DistrictType.BUSINESS_PARK),

            // ---- Retail Park (new) ----
            CivicSpec("Ashcombe Supermarket",     BuildingType.GROCER,
                x=202, y=145, w=7, h=5, doorX=205, doorY=144, noise=20.0, capacity=40, value=250_000.0,
                districtType=DistrictType.RETAIL_PARK),
            CivicSpec("Retail Park Sports Hall",  BuildingType.SPORTS_HALL,
                x=212, y=145, w=7, h=5, doorX=215, doorY=144, noise=28.0, capacity=50, value=180_000.0,
                districtType=DistrictType.RETAIL_PARK),
            CivicSpec("Retail Café",              BuildingType.CAFE,
            ...
            CivicSpec("The Anchor Bar",           BuildingType.PUB,
                x=252, y=5, w=4, h=3, doorX=254, doorY=10, noise=55.0, capacity=20, value=70_000.0,
                districtType=DistrictType.NIGHTLIFE_QUARTER),
            CivicSpec("Nightlife Police Post",    BuildingType.POLICE_STATION,
                x=260, y=5, w=3, h=3, doorX=261, doorY=10, noise=15.0, capacity=6, value=60_000.0,
                districtType=DistrictType.NIGHTLIFE_QUARTER),
